...
Ceiling::Ceiling(string name, Vector3 position, Vector3 rotation, Vector3 scale)
	:
	...
	mat.gfxData.Set(Vector4(0.4f, 0.4f, 0.4f, 0), Vector4(0.4f, 0.4f, 0.4f, 0), Vector4(0.0f, 0.0f, 0.0f, 1));
...
void Ceiling::Update(float dTime)
{
