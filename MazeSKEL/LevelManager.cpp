...
void LevelManager::initialise() {
	Level1* level1 = new Level1("Level1", 20.0f);
	Level2* level2 = new Level2("Level2", 30.0f);
	Level3* level3 = new Level3("Level3", 30.0f);
	Level4* level4 = new Level4("Level4", 45.0f);
	Level5* level5 = new Level5("Level5", 45.0f);
	Level6* level6 = new Level6("Level6", 100.0f);
